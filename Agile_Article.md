...
# What is the Agile handoff?
  A handoff is "the sharing of knowledge and status so that the next person can continue working smoothly."

  -So why is handing off to yourself important?-
  Sharing information is paramount when you need to do handoff to someone else. However, this also applies to self-handoffs.
  When you return to a project hours or days later, it is crucial to maintain development efficiency.
  You must prepare so that your future self can receive enough information from your past self.

  There are other reasones here:
    -If you wait a few days, you may forget the connection procedure or package version.
    -When other people join the project, your notes become shared documents for other members.

#References
  -Agile Alliance on Handoffs [https://agilealliance.org/]
  -Handoff from Design to Development [Design in Agile] [https://medium.com/agileinsider/ux-in-agile-handoff-design-developer-29b7b515d0cc]
  -Handoff Hurt [https://www.scrum.org/resources/blog/handoffs-hurt#:~:text=Handoffs%20are%20the%20hidden%20drain,value%2C%20and%20structure%20over%20sense.]
